      ...
      <div className="row">
        ...
        <div className="col-9">
          <ul className="nav nav-tabs justify-content-center" id="my-account-details" role="tablist">
            ...
            <li className="nav-item" role="presentation">
              <button className="nav-link" id="payment-methods" data-bs-toggle="tab" data-bs-target="#my-account-payment-method" type="button" role="tab" aria-selected="false" onClick={handlePaymentMethodTabClick}>Payment method</button>
            </li>
          </ul>
          <div className="row tab-margin">
            <div className="col">
              <div className="tab-content" id="my-account-content">
                ...
                <PaymentMethod id={"my-account-payment-method"} ref={paymentMethodRef} />
              </div>
            </div>
          </div>
        </div>              
